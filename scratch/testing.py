...
###                   print("PolicyName: {}".format (policy_name))
                   for policy_ver in response['Versions']:
                       ...
                       if policy_ver['IsDefaultVersion'] is True:
                            ...
                            if delta_time.days >= days_to_delete:
                               action="delete"
                               print(f'Would Perform Delete {policy_name} {policy_version} {delta_time.days} days')
                            else:
                   ...
                   output_row = "{},{},{},{},{},{},{},{},{},{},{}\n".format(
                               ...
                               policy_isdefault, formatted_policy_create_date, policy_version,
